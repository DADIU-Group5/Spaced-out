...
//Version=1.6
Shader"UNOShader/_Library/UNLIT/UNOShaderUNLIT Transparent Color Diffuse Rim Outline SH "
{
	Properties
	{
	...
	SubShader
	{
		...
		UsePass "UNOShader/_Library/Helpers/Shadows Transparent/SHADOWCAST"
	} //-------------------------------SubShader-------------------------------
