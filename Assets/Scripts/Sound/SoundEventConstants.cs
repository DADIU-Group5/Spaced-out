...
{
    // Ambient hazard - environment sounds
    ...
    public const string SWITCH_OFF = "switchOff";
    ...
    public const string DAVE_FIRST_LAUNCH_2 = "daveFirstLaunch_02";
    ...
    // Scene sounds
    public const string MUSIC = "musicPlay";
